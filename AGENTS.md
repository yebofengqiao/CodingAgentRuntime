...
- Use [README.md](README.md) and the public showcase docs under [docs/showcase/](docs/showcase/) for project context, narrative, and demo flow.
...
- 仓库根 `AGENTS.md` 作为默认 repo context 常驻加载。
- 具体任务技能放在仓库根 `.agents/skills/` 下，支持 legacy `.md` 和目录型 `SKILL.md`。
- 新增技能时，优先让 skill 内容直接服务于实际 runtime / eval / frontend 改造任务，而不是只做演示。
